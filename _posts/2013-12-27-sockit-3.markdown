...
between the UART to the USB Blaster. First, we need to convert our .sof file
into a raw binary file. To do this, you can use the `quartus_cdf` tool.
Run the following command from your project directory.

    quartus_cdf -c output_files/sockit_test.sof output_files/sockit_test.rbf

Then copy the "sockit\_test.rbf" file to the "/root" folder of the Linux
partition on your SD card. Then, boot the HPS and login through the serial.
You can then run the following command to program the FPGA.
...
[Part 4 ->](/blog/2013/12/29/sockit-4.html)
