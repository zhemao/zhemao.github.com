---
title: Trying out the Arrow SoCKit Part II - Installing Linux
layout: default
category: blog
---
...
Github repo for this site</a> and hopefully I or, if you're lucky, someone
more experienced than I will be able to tell what's going wrong.</p>
</div>
...
Clone the sources of the kernel for the SoCKit from RocketBoards.org.
    ...
    cd linux-socfpga
    git checkout -b sockit rel_13.02_RC10

You will also need to download the
[Linaro ARM toolchain](http://releases.linaro.org/13.11/components/toolchain/binaries/gcc-linaro-arm-linux-gnueabihf-4.8-2013.11_linux.tar.xz)
to get the cross-compiler. Extract the tarball anywhere on your system and
...
Then copy kernel and device tree onto the filesystem and unmount it.
    ...
    sudo cp arch/arm/boot/socfpga_cyclone5.dtb /mnt/socfpga.dtb
    sudo umount /mnt
...
[<- Part 1](/blog/2013/12/22/sockit-1.html)
